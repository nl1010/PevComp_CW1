...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2af0e7077cf8, const void *arg_0x2af0e7076020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2af0e70f8618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
# 65 "/usr/src/tinyos/tos/lib/tossim/tos.h"
...
# 51 "/usr/src/tinyos/tos/lib/tossim/sim_tossim.h"
...
# 50 "/usr/src/tinyos/tos/lib/tossim/sim_event_queue.h"
struct sim_event;
...
# 53 "/usr/src/tinyos/tos/lib/tossim/sim_mote.h"
...
# 65 "/usr/src/tinyos/tos/lib/tossim/sim_log.h"
...
# 97 "/usr/src/tinyos/tos/lib/tossim/tos.h"
...
# 9 "/usr/src/tinyos/tos/lib/tossim/hashtable.h"
struct hashtable;
typedef struct hashtable hashtable_t;
#line 78
struct hashtable *
create_hashtable(unsigned int minsize, 
unsigned int (*hashfunction)(void *arg_0x2af0e73398e8), 
int (*key_eq_fn)(void *arg_0x2af0e73380c8, void *arg_0x2af0e7338368));
#line 103
#line 102
int 
...
# 47 "/usr/src/tinyos/tos/lib/tossim/sim_log.c"
...
inline static int sim_log_eq(void *key1, void *key2);
# 65 "/usr/src/tinyos/tos/lib/tossim/heap.h"
#line 61
typedef struct heap {
  int size;
  void *data;
...
# 58 "/usr/src/tinyos/tos/lib/tossim/heap.c"
...
#line 197
static void up_heap(heap_t *heap, int findex);
# 44 "/usr/src/tinyos/tos/lib/tossim/sim_event_queue.c"
...
# 51 "/usr/src/tinyos/tos/lib/tossim/sim_noise.h"
...
# 51 "/usr/src/tinyos/tos/lib/tossim/sim_tossim.c"
...
bool sim_remove_channel(char *channel, FILE *file)   ;
# 99 "/usr/src/tinyos/tos/lib/tossim/sim_csma.h"
...
# 44 "/usr/src/tinyos/tos/lib/tossim/sim_csma.c"
...
void sim_csma_set_ack_time(int val)   ;
# 57 "/usr/src/tinyos/tos/lib/tossim/sim_gain.h"
#line 53
...
# 6 "/usr/src/tinyos/tos/lib/tossim/sim_gain.c"
#line 3
...
double sim_gain_sensitivity()   ;
# 39 "/usr/src/tinyos/tos/lib/tossim/randomlib.c"
...
static inline void RandomInitialise(int arg_0x2af0e7549610, int arg_0x2af0e7549878);
static double RandomUniform(void );
...
#line 419
void makeNoiseModel(uint16_t node_id)   ;
# 59 "/usr/src/tinyos/tos/lib/tossim/sim_packet.h"
...
# 12 "/usr/src/tinyos/tos/lib/tossim/TossimRadioMsg.h"
#line 6
...
# 53 "/usr/src/tinyos/tos/lib/tossim/platform_message.h"
#line 50
...
# 48 "/usr/src/tinyos/tos/lib/tossim/sim_packet.c"
...
typedef nx_struct NodeToNodeMsg {
  nx_uint16_t NodeID;
  nx_uint16_t Data;
} __attribute__((packed)) NodeToNodeMsg;
...
# 51 "/usr/src/tinyos/tos/chips/atm128/sim/atm128hardware.h"
...
# 54 "/usr/src/tinyos/tos/platforms/micaz/sim/platform_hardware.h"
...
# 41 "/usr/src/tinyos/tos/lib/tossim/SimMainP.nc"
...
typedef TMilli NetworkNodeC$DisseminationTriggerTimer$precision_tag;
...
static void NetworkNodeC$AMControl$startDone(error_t error);
#line 138
static void NetworkNodeC$AMControl$stopDone(error_t error);
...
static void NetworkNodeC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void NetworkNodeC$DisseminationTriggerTimer$fired(void );
...
# 44 "/usr/src/tinyos/tos/lib/tossim/SimMote.nc"
...
uint8_t len);
# 85 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModel.nc"
...
# 57 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModel.nc"
...
# 60 "/usr/src/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
# 60 "/usr/src/tinyos/tos/lib/tossim/ActiveMessageAddressC.nc"
...
# 44 "/usr/src/tinyos/tos/chips/atm128/timer/HplAtm128TimerAsync.nc"
...
# 48 "/usr/src/tinyos/tos/chips/atm128/timer/HplAtm128Compare.nc"
...
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
static error_t NetworkNodeC$AMControl$start(void );
...
NetworkNodeC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t NetworkNodeC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void NetworkNodeC$DisseminationTriggerTimer$startPeriodic(uint32_t dt);
# 35 "NetworkNodeC.nc"
bool NetworkNodeC$_radioBusy[1000];
message_t NetworkNodeC$_packet[1000];
uint8_t NetworkNodeC$flag_package_hold[1000];
int NetworkNodeC$flag_forward_limit[1000];
uint16_t NetworkNodeC$_holded_data[1000];


static inline void NetworkNodeC$Boot$booted(void );
#line 54
static void NetworkNodeC$AMSend$sendDone(message_t *msg, error_t error);
#line 69
static inline void NetworkNodeC$AMControl$startDone(error_t error);
#line 100
static inline void NetworkNodeC$DisseminationTriggerTimer$fired(void );
#line 129
static inline void NetworkNodeC$AMControl$stopDone(error_t error);




static inline message_t *NetworkNodeC$Receive$receive(message_t *msg, void *payload, uint8_t len);
# 62 "/usr/src/tinyos/tos/interfaces/Init.nc"
...
# 21 "/usr/src/tinyos/tos/platforms/mica/sim/MeasureClockC.nc"
...
# 51 "/usr/src/tinyos/tos/lib/tossim/SimMainP.nc"
...
# 50 "/usr/src/tinyos/tos/lib/tossim/SimMoteP.nc"
...
void sim_mote_enqueue_boot_event(int mote)   ;
# 57 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
...
# 62 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
...
# 48 "/usr/src/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
# 96 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
# 58 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
...
static inline void CpmModelC$free_receive_message(CpmModelC$receive_message_t *msg);
# 65 "/usr/src/tinyos/tos/lib/tossim/ActiveMessageAddressC.nc"
...
# 38 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$__nesc_unnamed4332 {
...
# 57 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
static error_t /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
...
# 317 "/usr/src/tinyos/tos/lib/tossim/sim_log.c"
inline static int sim_log_eq(void *key1, void *key2)
#line 317
{
...
# 130 "/usr/src/tinyos/tos/lib/tossim/sim_noise.c"
inline static unsigned int sim_noise_hash(void *key)
#line 130
{
  char *pt = (char *)key;
...
# 64 "/usr/src/tinyos/tos/lib/tossim/SimMoteP.nc"
static inline bool SimMoteP$SimMote$isOn(void )
#line 64
{
...
# 172 "/usr/src/tinyos/tos/lib/tossim/sim_log.c"
static inline void sim_log_add_channel(char *name, FILE *file)
#line 172
{
...
# 161 "/usr/src/tinyos/tos/lib/tossim/sim_gain.c"
static inline gain_entry_t *sim_gain_allocate_link(int mote)
#line 161
{
...
# 55 "/usr/src/tinyos/tos/lib/tossim/randomlib.c"
static inline void RandomInitialise(int ij, int kl)
{
  double s;
#line 57
...
# 284 "/usr/src/tinyos/tos/lib/tossim/sim_noise.c"
static inline void sim_noise_alarm()
#line 284
{
  dummy = 5;
...
# 50 "/usr/src/tinyos/tos/lib/tossim/sim_packet.c"
inline static tossim_header_t *getHeader(message_t *msg)
#line 50
{
...
# 236 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$active_message_deliver_handle(sim_event_t *evt)
#line 236
{
...
# 88 "/usr/src/tinyos/tos/lib/tossim/ActiveMessageAddressC.nc"
static inline am_addr_t ActiveMessageAddressC$amAddress(void )
#line 88
{
...
#line 134
{
  ...
  if (NetworkNodeC$flag_package_hold[sim_node()] == FALSE) {
      if (len == sizeof(NodeToNodeMsg )) {
          ...
          uint16_t node_id = __nesc_ntoh_uint16(incomingPacket->NodeID.nxdata);

#line 144
          NetworkNodeC$flag_package_hold[sim_node()] = TRUE;
          sim_log_debug(53U, "Channel", "%s RCV %hhu %hhu \n", sim_time_string(), data, node_id);
          sim_log_debug(54U, "Flag", "Package holded\n");
          NetworkNodeC$_holded_data[sim_node()] = data;
          return msg;
        }
      else 
#line 149
        {
          sim_log_debug(55U, "System", "Incorrect message received\n");
          return msg;
        }
    }
  else 
...
# 212 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline message_t *TossimActiveMessageC$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 212
{
  return msg;
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2af0e79841a0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2af0e79841a0) {
#line 78
    case 6:
#line 78
      __nesc_result = NetworkNodeC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2af0e79841a0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 216 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline message_t *TossimActiveMessageC$Snoop$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 216
{
  return msg;
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2af0e7984ce8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2af0e7984ce8, msg, payload, len);
#line 78
...
#line 78
# 89 "/usr/src/tinyos/tos/chips/atm128/sim/atm128hardware.h"
static __inline void __nesc_disable_interrupt()
#line 89
{
...
# 85 "/usr/src/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline void SimSchedulerBasicP$sim_scheduler_event_handle(sim_event_t *e)
#line 85
{
...
#line 57
# 120 "/usr/src/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline uint8_t SimSchedulerBasicP$popTask(void )
{
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
inline static error_t NetworkNodeC$AMControl$start(void ){
#line 104
...
#line 104
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t NetworkNodeC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 189 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void *TossimActiveMessageC$Packet$getPayload(message_t *msg, uint8_t len)
#line 189
{
  if (len <= 28) {
...
# 126 "/usr/src/tinyos/tos/interfaces/Packet.nc"
inline static void * NetworkNodeC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 222 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static inline uint32_t /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$Alarm$getNow(void )
#line 222
{
...
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void NetworkNodeC$DisseminationTriggerTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 69
{
  if (error == SUCCESS) {
      ...
      NetworkNodeC$DisseminationTriggerTimer$startPeriodic(1000);

      if (TOS_NODE_ID == 1) {

          NodeToNodeMsg *msg = (NodeToNodeMsg *)NetworkNodeC$Packet$getPayload(&NetworkNodeC$_packet[sim_node()], sizeof(NodeToNodeMsg ));

#line 78
          __nesc_hton_uint16(msg->NodeID.nxdata, TOS_NODE_ID);
          __nesc_hton_uint16(msg->Data.nxdata, (uint16_t )TOS_NODE_ID);




          if (NetworkNodeC$AMSend$send(AM_BROADCAST_ADDR, &NetworkNodeC$_packet[sim_node()], sizeof(NodeToNodeMsg )) == SUCCESS) {
              NetworkNodeC$_radioBusy[sim_node()] = TRUE;

              sim_log_debug(50U, "Channel", "%s SND %hhu \n", sim_time_string(), __nesc_ntoh_uint16(msg->Data.nxdata));
            }
        }
    }
  else 
    {
      NetworkNodeC$AMControl$start();
      sim_log_debug(51U, "System", "AMControl cannot boot, retry\n");
    }
}
...
#line 113
  NetworkNodeC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  NetworkNodeC$AMControl$stopDone(error);
#line 138
}
#line 138
# 101 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$stopDoneTask$runTask(void )
#line 101
{
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2af0e7985060, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2af0e7985060, msg, error);
#line 110
}
#line 110
# 103 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$Model$sendDone(message_t *msg, error_t result)
#line 103
{
...
# 76 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModel.nc"
...
#line 76
# 82 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline tossim_metadata_t *TossimPacketModelC$getMetadata(message_t *msg)
#line 82
{
...
#line 83
# 226 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static inline uint32_t /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$Alarm$getAlarm(void )
#line 226
{
...
#line 129
# 204 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static inline void /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$Alarm$stop(void )
#line 204
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  NetworkNodeC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2af0e7e1be18, message_t * msg, error_t error){
#line 100
  switch (arg_0x2af0e7e1be18) {
#line 100
    case 0U:
#line 100
      /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2af0e7e1be18, msg, error);
#line 100
      break;
#line 100
    }
...
# 221 "/usr/src/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline void SimSchedulerBasicP$TaskBasic$default$runTask(uint8_t id)
{
}

# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2af0e764a020){
#line 75
  switch (arg_0x2af0e764a020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2af0e764a020);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2af0e7e18020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2af0e7e18020, addr, msg, len);
#line 80
...
# 65 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline tossim_header_t *TossimActiveMessageC$getHeader(message_t *amsg)
#line 65
{
...
# 483 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline void CpmModelC$free_receive_message(CpmModelC$receive_message_t *msg)
#line 483
{
  free(msg);
...
# 61 "/usr/src/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
#line 85
# 288 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$GainRadioModel$receive(message_t *msg)
#line 288
{
...
#line 60
# 260 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline bool CpmModelC$checkReceive(CpmModelC$receive_message_t *msg)
#line 260
{
...
#line 296
{
  ...
  sim_log_debug(138U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 311
    if (mine == CpmModelC$outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(139U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 317
  sim_log_debug(140U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC$checkReceive(mine)) {
      sim_log_debug(141U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
  if (! mine->lost) {
...
#line 327
      ...
      sim_log_debug_clear(142U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(143U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(144U, "CpmModelC", " no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC$Model$shouldAck(mine->msg)) {
          sim_log_debug_clear(145U, "CpmModelC", " scheduling ack.\n");
...
#line 48
# 280 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$send_transmit_done(sim_event_t *evt)
#line 280
{
...
# 459 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline void CpmModelC$Model$setPendingTransmission(void )
#line 459
{
...
# 57 "/usr/src/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
#line 57
# 211 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline bool CpmModelC$Model$clearChannel(void )
#line 211
{
...
# 56 "/usr/src/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
#line 56
# 211 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$send_backoff(sim_event_t *evt)
#line 211
{
...
#line 57
# 90 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline double CpmModelC$timeInMs(void )
#line 90
{
...
# 127 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline bool TossimActiveMessageC$Model$shouldAck(message_t *msg)
#line 127
{
...
# 87 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModel.nc"
...
#line 87
# 296 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$GainRadioModel$acked(message_t *msg)
#line 296
{
  if (TossimPacketModelC$running[sim_node()]) {
...
# 59 "/usr/src/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
#line 59
# 151 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline double CpmModelC$arr_estimate_from_snr(double SNR)
#line 151
{
  double beta1 = 0.9794;
...
# 61 "/usr/src/tinyos/tos/lib/tossim/SimMoteP.nc"
static inline long long int SimMoteP$SimMote$getStartTime(void )
#line 61
{
...
# 127 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static inline sim_time_t HplAtm128Timer0AsyncP$notify_clockTicksPerSec(void )
#line 127
{
...
#line 100
{
  ...
  if (NetworkNodeC$flag_package_hold[sim_node()] == TRUE && NetworkNodeC$flag_forward_limit[sim_node()] > 0) {
...
#line 106
      __nesc_hton_uint16(msg->NodeID.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(msg->Data.nxdata, NetworkNodeC$_holded_data[sim_node()]);


      if (NetworkNodeC$AMSend$send(AM_BROADCAST_ADDR, &NetworkNodeC$_packet[sim_node()], sizeof(NodeToNodeMsg )) == SUCCESS) {
          NetworkNodeC$_radioBusy[sim_node()] = TRUE;
          sim_log_debug(52U, "Channel", "%s SND %hhu \n", sim_time_string(), __nesc_ntoh_uint16(msg->Data.nxdata));
        }
      ...
      NetworkNodeC$flag_forward_limit[sim_node()] = NetworkNodeC$flag_forward_limit[sim_node()] - 1;
    }
}
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2af0e7d6c2f8){
#line 83
  switch (arg_0x2af0e7d6c2f8) {
#line 83
    case 0U:
#line 83
      NetworkNodeC$DisseminationTriggerTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2af0e7d6c2f8);
#line 83
      break;
#line 83
    }
...
#line 83
# 145 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMPacket$setDestination(message_t *amsg, am_addr_t addr)
#line 145
{
...
# 103 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
inline static void /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
#line 103
# 170 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMPacket$setType(message_t *amsg, am_id_t t)
#line 170
{
  tossim_header_t *header = TossimActiveMessageC$getHeader(amsg);
...
inline static void /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
# 181 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$Packet$setPayloadLength(message_t *msg, uint8_t len)
#line 181
{
...
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static error_t /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 61
# 569 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static inline int HplAtm128Timer0AsyncP$TimerAsync$compareBusy(void )
#line 569
{
...
#line 44
# 74 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static inline void /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$setOcr0(uint8_t n)
#line 74
{
...
# 577 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static inline void HplAtm128Timer0AsyncP$cancel_compare(void )
#line 577
{
...
# 230 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static inline void /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$Timer$overflow(void )
#line 230
{
}
...
#line 82
# 85 "/usr/src/tinyos/tos/chips/atm128/sim/atm128hardware.h"
static __inline void __nesc_enable_interrupt()
#line 85
{
  atm128RegFile[sim_node()][* (volatile uint8_t *)&atm128RegFile[sim_node()][0x3F]] |= 1 << 7;
...
#line 48
# 149 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static inline void /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$Compare$fired(void )
#line 149
{
  int overflowed;
...
#line 67
# 61 "/usr/src/tinyos/tos/platforms/micaz/MotePlatformP.nc"
static inline error_t MotePlatformP$SubInit$default$init(void )
#line 61
{
  return SUCCESS;
...
#line 41
# 62 "/usr/src/tinyos/tos/chips/atm128/pins/sim/HplAtm128GeneralIOPinP.nc"
static __inline void /*HplAtm128GeneralIOC.PortA.Bit4*/HplAtm128GeneralIOPinP$4$IO$makeInput(void )
#line 62
{
#line 62
...
#line 65
# 86 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline error_t TossimPacketModelC$Init$init(void )
#line 86
{
...
# 447 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static inline void HplAtm128Timer0AsyncP$Compare$start(void )
#line 447
{
#line 447
...
#line 65
# 364 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static inline void HplAtm128Timer0AsyncP$Timer0Ctrl$setControl(Atm128TimerControl_t x)
#line 364
{
...
# 46 "/usr/src/tinyos/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
#line 46
# 561 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static inline void HplAtm128Timer0AsyncP$TimerAsync$setTimer0Asynchronous(void )
#line 561
{
...
# 32 "/usr/src/tinyos/tos/chips/atm128/timer/HplAtm128TimerAsync.nc"
...
#line 32
# 54 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static inline error_t /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$Init$init(void )
#line 54
{
  /* atomic removed: atomic calls only */
...
static inline void NetworkNodeC$Boot$booted(void )
{
  sim_log_debug(46U, "System", "Mote Booted.\n");

  NetworkNodeC$AMControl$start();
  sim_log_debug(47U, "System", "Module:AMControl->Starting...\n");
}
...
# 46 "/usr/src/tinyos/tos/lib/tossim/sim_event_queue.c"
  void sim_queue_init()
#line 46
{
  init_heap(&eventHeap);
...
# 246 "/usr/src/tinyos/tos/lib/tossim/sim_log.c"
static void sim_log_debug(uint16_t id, char *string, const char *format, ...)
#line 246
{
  va_list args;
...
# 121 "/usr/src/tinyos/tos/lib/tossim/sim_tossim.c"
  unsigned long sim_node()
#line 121
{
  return current_node;
...
# 197 "/usr/src/tinyos/tos/lib/tossim/heap.c"
static void up_heap(heap_t *heap, int findex)
#line 197
{
  int parent_index;
...
# 55 "/usr/src/tinyos/tos/lib/tossim/sim_event_queue.c"
  sim_event_t *sim_queue_pop()
#line 55
{
  long long int key;
...
# 114 "/usr/src/tinyos/tos/lib/tossim/heap.c"
static void *heap_pop_min_data(heap_t *heap, long long int *key)
#line 114
{
...
# 60 "/usr/src/tinyos/tos/lib/tossim/sim_event_queue.c"
  bool sim_queue_is_empty()
#line 60
{
...
# 57 "/usr/src/tinyos/tos/lib/tossim/sim_tossim.c"
  void sim_init()
#line 57
{
  sim_queue_init();
...
# 234 "/usr/src/tinyos/tos/lib/tossim/sim_log.c"
static void sim_log_commit_change()
#line 234
{
  int i;
...
# 67 "/usr/src/tinyos/tos/lib/tossim/sim_noise.c"
  void sim_noise_init()
{
  int j;
...
# 102 "/usr/src/tinyos/tos/lib/tossim/sim_tossim.c"
  void sim_random_seed(int seed)
#line 102
{
...
# 134 "/usr/src/tinyos/tos/lib/tossim/SimMoteP.nc"
  bool sim_mote_is_on(int mote)
#line 134
{
  bool result;
...
# 276 "/usr/src/tinyos/tos/lib/tossim/sim_log.c"
static void sim_log_debug_clear(uint16_t id, char *string, const char *format, ...)
#line 276
{
  va_list args;
...
# 156 "/usr/src/tinyos/tos/lib/tossim/sim_tossim.c"
  int sim_print_time(char *buf, int len, sim_time_t ftime)
#line 156
{
  int hours;
...
# 57 "/usr/src/tinyos/tos/lib/tossim/sim_csma.c"
  int sim_csma_init_high()
#line 57
{
  return csmaInitHigh;
...
# 16 "/usr/src/tinyos/tos/lib/tossim/sim_gain.c"
  gain_entry_t *sim_gain_first(int src)
#line 16
{
  if (src > 1000) {
...
# 84 "/usr/src/tinyos/tos/lib/tossim/sim_noise.c"
  void sim_noise_create_model(uint16_t node_id)
#line 84
{
...
# 103 "/usr/src/tinyos/tos/lib/tossim/randomlib.c"
static double RandomUniform(void )
{
  double uni;
  int seed1;
...
# 364 "/usr/src/tinyos/tos/lib/tossim/sim_noise.c"
  char sim_noise_generate(uint16_t node_id, uint32_t cur_t)
#line 364
{
  uint32_t i;
...
# 261 "/usr/src/tinyos/tos/lib/tossim/sim_log.c"
static void sim_log_error(uint16_t id, char *string, const char *format, ...)
#line 261
{
  va_list args;
...
# 54 "/usr/src/tinyos/tos/lib/tossim/sim_packet.c"
  void sim_packet_set_source(sim_packet_t *msg, uint16_t src)
#line 54
{
...
# 254 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
  void active_message_deliver(int node, message_t *msg, sim_time_t t)
#line 254
{
...
# 76 "/usr/src/tinyos/tos/lib/tossim/ActiveMessageAddressC.nc"
static am_addr_t ActiveMessageAddressC$ActiveMessageAddress$amAddress(void )
#line 76
{
...
# 165 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static am_id_t TossimActiveMessageC$AMPacket$type(message_t *amsg)
#line 165
{
  tossim_header_t *header = TossimActiveMessageC$getHeader(amsg);
...
# 110 "/usr/src/tinyos/tos/lib/tossim/sim_packet.c"
  uint8_t sim_packet_max_length(sim_packet_t *msg)
#line 110
{
  return 28;
...
# 180 "/usr/src/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static bool SimSchedulerBasicP$Scheduler$runNextTask(void )
{
  uint8_t nextTask;
...
#line 54
{
  ...
  if (msg == &NetworkNodeC$_packet[sim_node()]) {
      NetworkNodeC$_radioBusy[sim_node()] = FALSE;
      NetworkNodeC$flag_forward_limit[sim_node()] = NetworkNodeC$flag_forward_limit[sim_node()] - 1;
      sim_log_debug(48U, "Flag", "Forward limit: %i.<if limit less then 1 then abort forwarding> \n", NetworkNodeC$flag_forward_limit[sim_node()]);
    }
  else 
    {
      sim_log_debug(49U, "System", "message sended but not correct.\n");
    }
}
...
# 73 "/usr/src/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static error_t TossimActiveMessageC$AMSend$send(am_id_t id, am_addr_t addr, 
message_t *amsg, 
uint8_t len)
#line 75
...
# 274 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static double CpmModelC$packetNoise(CpmModelC$receive_message_t *msg)
#line 274
{
  double noise = CpmModelC$noise_hash_generation();
...
# 248 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static bool CpmModelC$shouldReceive(double SNR)
#line 248
{
...
# 307 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static bool TossimPacketModelC$GainRadioModel$shouldAck(message_t *msg)
#line 307
{
  if (TossimPacketModelC$running[sim_node()] && !TossimPacketModelC$transmitting[sim_node()]) {
...
# 216 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static void CpmModelC$sim_gain_schedule_ack(int source, sim_time_t t, CpmModelC$receive_message_t *r)
#line 216
{
...
# 161 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static uint32_t /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$Counter$get(void )
#line 161
{
  uint32_t now;
...
# 282 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static uint8_t HplAtm128Timer0AsyncP$Timer0$get(void )
#line 282
{
  uint8_t rval;
...
# 106 "/usr/src/tinyos/tos/lib/tossim/SimMoteP.nc"
  long long int sim_mote_start_time(int mote)
#line 106
{
...
# 160 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static uint16_t HplAtm128Timer0AsyncP$shiftFromScale(void )
#line 160
{
...
#line 55
{
  /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*NetworkNodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 212 "/usr/src/tinyos/tos/chips/atm128/timer/Atm128AlarmAsyncP.nc"
static void /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$Alarm$startAt(uint32_t nt0, uint32_t ndt)
#line 212
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 463 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
static void HplAtm128Timer0AsyncP$Compare$set(uint8_t t)
#line 463
{
...
# 97 "/usr/src/tinyos/tos/lib/tossim/sim_event_queue.c"
static sim_event_t *sim_queue_allocate_event()
#line 97
{
  sim_event_t *evt = (sim_event_t *)malloc(sizeof(sim_event_t ));
...
# 100 "/usr/src/tinyos/tos/chips/atm128/timer/sim/HplAtm128Timer0AsyncP.nc"
  void INTERRUPT_16(void )
#line 100
{
...
# 106 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static error_t TossimPacketModelC$Control$start(void )
#line 106
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
...
{
  /* Module NetworkNodeC */
  if (!strcmp(varname, "NetworkNodeC$_radioBusy"))
  {
    *addr = (uintptr_t)&NetworkNodeC$_radioBusy[__nesc_mote];
    *size = sizeof(NetworkNodeC$_radioBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NetworkNodeC$_packet"))
  {
    *addr = (uintptr_t)&NetworkNodeC$_packet[__nesc_mote];
    *size = sizeof(NetworkNodeC$_packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NetworkNodeC$flag_package_hold"))
  {
    *addr = (uintptr_t)&NetworkNodeC$flag_package_hold[__nesc_mote];
    *size = sizeof(NetworkNodeC$flag_package_hold[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NetworkNodeC$flag_forward_limit"))
  {
    *addr = (uintptr_t)&NetworkNodeC$flag_forward_limit[__nesc_mote];
    *size = sizeof(NetworkNodeC$flag_forward_limit[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NetworkNodeC$_holded_data"))
  {
    *addr = (uintptr_t)&NetworkNodeC$_holded_data[__nesc_mote];
    *size = sizeof(NetworkNodeC$_holded_data[__nesc_mote]);
    return 0;
  }
...
{
  /* Module NetworkNodeC */
  NetworkNodeC$_radioBusy[__nesc_mote] = FALSE;
  memset((void *)&NetworkNodeC$_packet[__nesc_mote], 0, sizeof NetworkNodeC$_packet[__nesc_mote]);
  NetworkNodeC$flag_package_hold[__nesc_mote] = FALSE;
  NetworkNodeC$flag_forward_limit[__nesc_mote] = 1;
  memset((void *)&NetworkNodeC$_holded_data[__nesc_mote], 0, sizeof NetworkNodeC$_holded_data[__nesc_mote]);
